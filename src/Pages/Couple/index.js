    ...
    <>
      <div className='my-16'>
        ...
        <div id="mempelai" className='grid md:grid-cols-2 grid-cols-1 gap-4 lg:mx-32 mx-4'>
          <div>
            <center>
              <img src={pria} alt='mempelai-pria' data-aos="fade-up" loading="lazy" className='w-[300px] rounded-full border-4 border-[#D4AF37] shadow-lg' />
            </center>
            <h1 data-aos="fade-up" className='text-center custom-font-3 md:text-2xl text-lg text-[#413327] font-bold mb-4'>Mempelai Pria</h1>
            <h1 data-aos="fade-up" className='text-center custom-font-2 lg:text-6xl text-4xl text-[#413327] font-bold mb-2'>Muhammad Amin Iqbaal Alam, 
              <span style={{ fontFamily: '"Dancing Script", cursive', fontWeight: '500' }} className="text-[0.9em] ml-2"> S.Kom</span>
            </h1>
            <p data-aos="fade-up" className='text-[#413327] font-semibold text-center md:text-lg text-sm'>Putra Pertama dari <br /> Bapak <b>Ali Mas'ud, S.Pd</b> & Ibu <b>Chamsatun Masunah, S.H</b></p>
          </div>
          <div>
            <center>
              <img src={wanita} alt='mempelai-pria' data-aos="fade-up" loading="lazy" className='w-[300px] rounded-full border-4 border-[#D4AF37] shadow-lg' />
            </center>
            ...
            <h1 data-aos="fade-up" className='text-center custom-font-2 lg:text-6xl text-4xl text-[#413327] font-bold mb-2'>Velida Apria Ningrum, 
              <span style={{ fontFamily: '"Dancing Script", cursive', fontWeight: '500' }} className="text-[0.9em] ml-2"> S.Pd., M.Ag</span>
            </h1>
            <p data-aos="fade-up" className='text-[#413327] font-semibold text-center md:text-lg text-sm'>Putra Pertama dari <br /> Bapak <b>-</b> & Ibu <b>-</b></p>
          </div>
        </div>
      </div>
