...
export default function Reservasi() {
    ...
    const reservasi = () => {
        if (rsvpNama === '') {
            ...
            window.open(`https://api.whatsapp.com/send?phone=6285156964141&text=Hai%20Sandi%20%26%20May%2C%20saya%20*${rsvpNama}*%20ingin%20konfirmasi%20kehadiran%20pada%20undangan%20pernikahan%20kalian%20bahwa%20*${rsvpKonfir}*%20bersama%20*${rsvpTamu}*%20orang.%20Saya%20ucapkan%3A%0A*${rsvpPesan}*.%20Terima%20kasih%20ya.`, "_blank");
        }
    ...
    const [expiryTime, setExpiryTime] = useState("12 jan 2026 08:00:00");
