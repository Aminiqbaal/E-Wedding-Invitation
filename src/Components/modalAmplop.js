...
export default function ModalAmplop({ onClose, visible }) {
    ...
    const wapria = () => {
        window.open('https://api.whatsapp.com/send?phone=6285156964141', "_blank" );
    }
                            ...
                            <div className='grid md:grid-cols-3 grid-cols-1 gap-3 mb-3'>
                                <div>
                                    <div className='bg-[#dfc4a7] rounded-lg py-3 mb-2'>
                                        <h1 className='text-center font-medium text-[#413327] text-2xl'>BSI <br /> 0344863794 <br /> Velida Apria Ningrum</h1>
                                    </div>
                                ...
                                <div>
                                    <div className='bg-[#dfc4a7] rounded-lg py-3 mb-2'>
                                        <h1 className='text-center font-medium text-[#413327] text-2xl'>MANDIRI <br /> 1780007096809 <br /> M. Amin Iqbaal Alam</h1>
                                    </div>
                                ...
                                <div>
                                    <div className='bg-[#dfc4a7] rounded-lg py-3 mb-2'>
                                        <h1 className='text-center font-medium text-[#413327] text-2xl'>BLU (BCA) <br /> 008777453987 <br /> M. Amin Iqbaal Alam</h1>
                                    </div>
                                    <button onClick={() => {copyrekpria()}} className='py-3 bg-gray-500 rounded-lg w-full mb-2 text-white hover:bg-gray-700'>
                                        <FontAwesomeIcon icon={faCopy} className="mr-2" />
                                        Salin Nomor Rekening
